...
// ── NEW PALETTE ──────────────────────────────────────────
// ACCENT  = Deep navy    — dominant brand color, headers, primary buttons
// ACCENT2 = Plum         — second accent, equal weight to yellow, buttons/highlights
// GOLD    = Butter yellow — rewards, stars, celebration moments, calls to action
// BG      = Soft lavender-cream — warm but complements navy/plum
// CARD    = Lavender-tinted card bg — distinguishes cards from page bg
// TEXT    = Near-black with navy undertone
// SUB     = Warm grey-purple muted text
export const ACCENT  = "#1B2B5E"; // deep navy
export const ACCENT2 = "#7B3F7F"; // plum
export const GOLD    = "#F9E04B"; // butter yellow — reserved for rewards/stars/celebration
export const BG      = "#F5F3FF"; // lavender-cream page background
export const CARD    = "#EDE8FF"; // soft lavender card background
export const TEXT    = "#1A1530"; // near-black with navy undertone
export const SUB     = "#6B6080"; // muted warm grey-purple
